...
ShellRoot {
    ...
    Call {id:load;Component.onCompleted:run(["dream_snapshot"]);onReceived:function(d){if(!d.error)root.snapshot=d}}
        ...
        FloatingWindow {
            ...
            Item {anchors.fill:parent;focus:true;Keys.onPressed:function(event){event.accepted=true;Qt.quit()}
                ...
                Column {anchors.centerIn:parent;spacing:28
                    ...
                    Text {anchors.horizontalCenter:parent.horizontalCenter;text:"a small world, growing with yours";color:root.snapshot.palette.accent;opacity:0.35;font.pixelSize:13;font.letterSpacing:2}
                }
